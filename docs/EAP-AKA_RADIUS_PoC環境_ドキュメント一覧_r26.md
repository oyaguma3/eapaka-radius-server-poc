# EAP-AKA RADIUS PoC環境 ドキュメント一覧 (r26)
...
| B-02 | アプリケーションデプロイ手順書 | r6 | 2026-02-23 | リポジトリクローン、.env作成、Docker Compose起動、Admin TUI配置、logrotate設定、バックアップスクリプト配置、lnavフォーマット配置 |
