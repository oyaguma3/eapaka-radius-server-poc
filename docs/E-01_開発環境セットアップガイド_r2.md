...
| D-08 インフラ設定・運用設計書 (r3) | Docker Compose設定、環境変数 |
| D-09 Auth Server詳細設計書 (r5) | Auth Server環境変数、パッケージ依存 |
| D-10 Acct Server詳細設計書 (r2) | Acct Server環境変数、パッケージ依存 |
| D-11 Vector API詳細設計書 (r2) | Vector API環境変数、パッケージ依存 |
| D-12 Vector Gateway詳細設計書 (r2) | Vector Gateway環境変数、パッケージ依存 |
